      ...
      <div 
        ...
        style={{
          backgroundImage: `
            ...
            url('https://images.unsplash.com/photo-1482938289607-e9573fc25ebb?auto=format&fit=crop&w=2000&q=80')
          `,
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          backgroundAttachment: 'fixed'
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <h1 className="text-2xl font-bold bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">Find Drone Services</h1>
